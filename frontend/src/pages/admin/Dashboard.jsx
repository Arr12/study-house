...
export default function Dashboard({ setLoading, active, setActive }) {
  return (
    <LayoutAdminPage
    ...
    >
      <div className="px-4 pt-6 w-full">
        <div className="grid w-full grid-cols-1 gap-4 mt-4 lg:grid-cols-2">
        ...
        <div className="grid grid-cols-1 my-4">
          <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm xl:mb-0">
                    ...
                    <tbody className="bg-white">
                      <tr>
                        ...
                        <td className="p-4 whitespace-nowrap">
                          <span className="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-green-100 dark:border-green-500">
                            Completed
                          </span>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td className="p-4 whitespace-nowrap">
                          <span className="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-red-100 dark:border-red-400 dark:text-red-400">
                            Cancelled
                          </span>
                        </td>
                      </tr>
                      <tr className="bg-gray-50">
                        ...
                        <td className="p-4 whitespace-nowrap">
                          <span className="bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-purple-100 dark:border-purple-500 dark:text-purple-400">
                            In progress
                          </span>
                        </td>
                      </tr>
                      ...
                      <tr className="bg-gray-50">
                        ...
                        <td className="p-4 whitespace-nowrap">
                          <span className="bg-orange-100 text-orange-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-orange-100 dark:border-orange-300 dark:text-orange-300">
                            In review
                          </span>
                        </td>
                      </tr>
